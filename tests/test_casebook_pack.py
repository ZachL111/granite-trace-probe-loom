"""Regression checks for the granite-trace-probe-loom casebook."""
...
from casebook.harness import assert_expected, granite_trace_probe_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_trace_probe_loom_summary(), assert_expected())
